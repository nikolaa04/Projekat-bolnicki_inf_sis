            ...
            <div class="col-md-3 sidebar">
                ...
                if (isset($_REQUEST["success"])) {
                    if ($_GET["success"] == 1) {
                        ...
                        echo 'Dijagnoza je uspešno ažurirana';
                        echo '</div>';
                    }
                    ...
                    <div class="card-body">
                        ...
                        if ($result->num_rows > 0) {
                            while ($data = $result->fetch_object()) {
                                ...
                                echo '<form action="php/updateDijagnoza.php" method="post">';
                                echo '<input type="hidden" name="dijagnoza_id" value="' . $data->dijagnoza_id . '">';
                                echo '<div class="form-group">';
                                echo '<label for="naziv">Naziv:</label>';
                                echo '<input type="text" name="naziv" class="form-control" value="' . $data->naziv . '">';
                                echo '</div>';
                                echo '<div class="form-group">';
                                echo '<label for="opis">Opis:</label>';
                                echo '<textarea name="opis" class="form-control" rows="4">' . $data->opis . '</textarea>';
                                echo '</div>';
                                echo '<button type="submit" class="btn btn-primary">Ažuriraj dijagnozu</button>';
                                echo '</form>';
